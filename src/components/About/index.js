    ...
    return (
        <section className="my-5">
            ...
            <div className="shadow-box p-2 max-w-95 md:max-w-3/4 mx-auto flex-col justify-center">
                ...
                <br></br>
                <div className="flex"><button className="flex justify-center mx-auto"><a className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded items-center mx-auto flex justify-center" href={myResume} rel="noreferrer" target="_blank"><svg class="fill-current w-4 h-4 mr-2" viewBox="0 0 20 20"><path d="M13 8V2H7v6H2l8 8 8-8h-5zM0 18h20v2H0v-2z"/></svg><span>Download my Resume</span></a></button></div>
            </div>
        </section>
    );
}
